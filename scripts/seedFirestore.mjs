...
const news = [
  { newsId: 'fact-001', artistId: 'bigbang-gd', tourId: 'bigbang-20th-tour', language: 'ko', title: '빅뱅 20주년 월드투어 공식 티켓 오픈 공지', factSummary: ['고양 종합운동장 2회 공연 티켓 예매가 3월 15일 오후 8시 시작됩니다.', 'VIP 패키지에는 사운드체크 입장권 및 공식 MD가 포함됩니다.', '해외 17개 도시 상세 일정은 공식 홈페이지를 통해 순차 공개됩니다.'], sourceName: '갤럭시코퍼레이션 공식 공지', sourceUrl: 'https://galaxycorp.example.com', isOfficial: true, publishedAt: '2026-03-01T10:00:00Z' },
  { newsId: 'fact-002', artistId: 'bigbang-gd', tourId: 'bigbang-20th-tour', language: 'ja', title: 'BIGBANG 2026年日本4大ドームツアー開催決定', factSummary: ['大阪・名古屋・東京・福岡の4大ドームで全8公演を実施。', '日本ファンクラブ先行予約受付は4月1日より開始予定。'], sourceName: '日本公式プレスリリース', sourceUrl: 'https://bigbang-jp.example.com', isOfficial: true, publishedAt: '2026-03-02T11:00:00Z' },
  { newsId: 'fact-003', artistId: 'bigbang-gd', tourId: 'bigbang-20th-tour', language: 'en', title: 'BIGBANG 20th Anniversary World Tour Tickets Announcement', factSummary: ['Tickets for North America (NYC) and Europe (London/Paris) open on April 10.', 'VIP Soundcheck and exclusive merchandise packages available.', 'World Tour spans 18 cities with 31 shows globally.'], sourceName: 'Live Nation Global Official', sourceUrl: 'https://livenation.example.com', isOfficial: true, publishedAt: '2026-03-03T12:00:00Z' },
  { newsId: 'fact-004', artistId: 'bigbang-gd', tourId: 'bigbang-20th-tour', language: 'zh', title: 'BIGBANG 20週年世界巡迴 台北·高雄站門票即將開賣', factSummary: ['台北大巨蛋與高雄國家體育場共計4場演出門票將於4月15日開賣。', '官方售票系統為拓元售票，實名制購票以防黃牛。'], sourceName: '台灣主辦單位官方公告', sourceUrl: 'https://tixcraft.example.com', isOfficial: true, publishedAt: '2026-03-04T10:00:00Z' }
];

async function seed() {
  console.log(`🚀 [${firebaseConfig.projectId}] Cloud Firestore에 데이터 주입을 시작합니다...`);
  ...
  for (const n of news) {
    const ref = doc(db, 'newsFacts', n.newsId);
    batch.set(ref, n);
  }

  await batch.commit();
  console.log('🎉 18개 도시 투어 일정 및 5개 국어 팩트 뉴스가 Cloud Firestore에 성공적으로 저장되었습니다!');
}
