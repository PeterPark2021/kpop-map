...
export const WorldTourMap: React.FC<Props> = ({ events, lang, onSelectEvent }) => {
  ...
  const getVenueString = (venue: string | LocalizedString | undefined): string => {
    if (!venue) return '';
      ...
      {viewTab === 'map' ? (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '14px' }}>
          {events.map(ev => {
            ...
            const venueText = getVenueString(ev.venueName);
            ...
            return (
              ...
              >
                ...
                <p style={{ margin: '0 0 6px 0', color: '#94a3b8', fontSize: '12px' }}>{venueText}</p>
