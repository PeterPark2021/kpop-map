...
export function generateUnsubscribeToken(uid: string, secretKey: string = DEFAULT_SECRET, validDays: number = 90): string {
...
export function verifyUnsubscribeToken(token: string, secretKey: string = DEFAULT_SECRET): { valid: boolean; uid?: string; error?: string } {
